...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun performRegister() {
        ...
        val passwordAgain=password_again_edittext_register.text.toString()
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl:String){
        ...
        val user= User(uid,username_edittext_register.text.toString(),phone_edittext_register.text.toString(),profileImageUrl)
